...
class MLP_regression:
    ...
    def __init__(self,
        ...
        cmodel = input1
        cmodel = keras.layers.Flatten()(cmodel)
        cmodel = keras.layers.Dense(MLP_nodes, activation='elu')(cmodel)
        ...
        # cmodel = keras.layers.Dropout(0.00,seed=338)(cmodel)
...
class MLP_classifier:
    def __init__(self,
        ...
        cmodel = keras.layers.Dense(MLP_nodes, activation='elu')(cmodel)
        cmodel = keras.layers.BatchNormalization(axis=-1)(cmodel)
        # cmodel = keras.layers.Dropout(0.40,seed=338)(cmodel)
        
        cmodel = keras.layers.Dense(2, activation='linear')(cmodel)
        # cmodel = keras.layers.Dropout(0.4,seed=338)(cmodel)
        cmodel = keras.layers.Softmax()(cmodel)
